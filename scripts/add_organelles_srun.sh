...
srun -c 10 oatk -k 1001 -c 30 -t 10 -m ${MITO} -p ${CP} -o ${OUTPUT} ${UNANCHORED}
...
srun -c 128 minimap2 -I 128G -ax map-pb -t 128 -c --secondary=no ${OUTPUT}_primary_organelles.fasta ${UNANCHORED} > ${OUTPUT}_unanchored2primary_organelle.sam
