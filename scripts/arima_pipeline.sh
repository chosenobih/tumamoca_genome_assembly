...
#ASSEMBLY="/data2/service_center_analyses/tumamoca_genome/raw_data/tumamoca_long_hifiasm.hic.hap1.p_ctg.fa"
...
srun -c 200 /data2/castri/HapHiC/haphic pipeline ${ASSEMBLY} ${HIC_BAM} ${Chr} --correct_nrounds 2 --remove_allelic_links ${Ploidy} --threads 200 --RE $RE --prefix ${NAME}_Haphic
...
### Plot contact map for scaffolded assembly
srun -c 200 /data2/castri/HapHiC/haphic plot --threads 200 ./04.build/out_JBAT.assembly.agp ./Arima/pair/${SRA}.bam

### Housekeeping
mv HapHiC_plot.log ${NAME}_HapHIC
mv contact* ${NAME}_HapHIC
mv Arima* ${NAME}_HapHIC
mv 0* ${NAME}_HapHIC
